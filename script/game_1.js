...
$("#safety_group_button").click(function(){
    ...
    $("#group_main_text_1").text(`Состав: Анджена (678_АЛ),Верон (8009_АН),Принал (453_АП),Ян (7764_АА)`)
    $("#group_main_text_2").text(`Область работ: планеты с низкими температурами, ураганами, песчаными бурями; помощь в строительстве подземных жилых комплексов`)
    $("#group_main_text_3").text(`Ближайшая свободная дата: 27.06.45`)
    $("#group_main_text_4").text(`Отчет последней операции:Вывезено 89 человек из воздушного саркофага №8 на планете О-98 во время песчаного урагана 11 баллов. `)
})
...
$("#group_text_name_next").click(function(){
    ...
    `)
    $("#group_main_text_2").text(`Область работ: экстренные ситуации с землетрясениями, разгребание завалов с поиском людей `)
